...
import static org.apache.commons.fileupload2.core.AbstractFileUpload.CONTENT_LENGTH;
...
public class UploadServlet extends HttpServlet implements Servlet {
     ...
     * @param request
     */
    public static void removeSessionFileItems(HttpServletRequest request, String sessionFilesKey) throws IOException {
     ...
     */
    public static void removeSessionFileItems(HttpServletRequest request) throws IOException {
     ...
     */
    public static void removeSessionFileItems(HttpServletRequest request, String sessionFilesKey, boolean removeData) throws IOException {
     ...
     * the user can specify whether the temporary data is removed from disk.
     */
    public static void removeSessionFileItems(HttpServletRequest request, boolean removeData) throws IOException {
     ...
     * @param response
     * @param xmlResponse
     * @param post     specify whether the request is post or not.
     * @throws IOException
     */
    ...
    protected FileItemFactory getFileItemFactory(long requestSize) {
        return new JakartaServletDiskFileUpload().getFileItemFactory();
    }
